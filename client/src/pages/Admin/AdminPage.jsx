...
const SideBareContent = ()=>{
    return(
        <>
            <div>
                    <Link className='flex items-start justify-start m-3 mb-12 p-2 rounded-2xl' to='/administrator/dashboard'>
                        <img 
                            src={logo} 
                            height={50} 
                            width={50} 
                ...
                <div>
                    <Link className='flex items-center justify-start mt-3 mx-3 p-2 rounded-lg hover:bg-gray-200 transition-colors duration-200' to='/administrator/dashboard'>
                        <img 
                            src={Dashicon} 
                            height={30} 
                            width={30} 
                ...
                <div>
                    <Link className='flex items-center justify-start mx-3 p-2 rounded-lg hover:bg-gray-200 transition-colors duration-200' to='/administrator/users'>
                        <img 
                            src={usericon} 
                            height={30} 
                            width={30} 
                ...
                <div>
                    <Link className='flex items-center justify-start mx-3 p-2 rounded-lg hover:bg-gray-200 transition-colors duration-200' to='/administrator/tickets'>
                        <img 
                            src={ticketicon} 
                            height={30} 
                            width={30} 
                ...
                <div>
                    <Link className='flex items-center justify-start mx-3 p-2 rounded-lg hover:bg-gray-200 transition-colors duration-200' to='/administrator/profile'>
                        <img 
                            src={user_accicon} 
                            height={30} 
                            width={30} 
